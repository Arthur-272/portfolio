      ...
      <div className="portfolio--container-box">
        ...
        <div>
          <button
            ...
            onClick={() =>
              window.open("https://github.com/Arthur-272", "_blank")
            }
          >
            <svg
            ...
            <a href="https://github.com/Arthur-272" />
            Visit My GitHub
          </button>
        </div>
      </div>
        ...
        {data?.portfolio?.map((item, index) => (
          <div
            ...
            className={`portfolio--section--card ${
              item.title === "Online Trivia Game" ? "no-elevate no-click" : ""
            }`}
            onClick={
              item.title === "Online Trivia Game"
                ? null
                : () => window.open(item.link, "_blank")
            }
            style={{
              cursor:
                item.title === "Online Trivia Game" ? "default" : "pointer",
            }}
          >
